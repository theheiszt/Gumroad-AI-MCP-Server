...
export const config = {
  ...
  gumroadWebhookVerificationMode:
    (process.env.GUMROAD_WEBHOOK_VERIFICATION_MODE as "auto" | "header-hmac" | "body-secret" | undefined) ?? "auto",
  ...
  processWebhookEventsIntervalMs: numberFromEnv(process.env.PROCESS_WEBHOOK_EVENTS_INTERVAL_MS, 30 * 1000),
